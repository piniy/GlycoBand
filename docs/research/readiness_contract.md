...
| D-Trend — Scientific freeze | Trend protocol and chronological split approved and versioned | Project lead | `PASS` | `configs/trend/label-v1.yaml`; `data/manifests/trend_split-v1.json` | None; 27,913 causal endpoints from 16 participants passed split and raw-history validation | Project lead approval recorded in `gate_d_decision_brief.md` on 2026-08-25 |
